                        ...
                        <div className="container">
                            ...
                            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                                ...
                                <ul className="navbar-nav ms-auto align-items-center">
                                    ...
                                    {window.location.pathname !== '/addNote' && <li className="nav-item pe-4">
                                        ...
                                        <li className="nav-item dropdown">
                                            ...
                                            <ul className="dropdown-menu dropdown-menu-end">
                                                <li><Link className="dropdown-item" to="/profile">
                                                    {/* <i className="fa-solid fa-user-large pe-2"></i> */}
                                                    Profile</Link></li>
                                                {/* <li><hr className="dropdown-divider" /></li> */}
                                                <li><a className="dropdown-item" style={{ cursor: 'pointer' }} onClick={handleLogout} >Log out</a></li>
                                            </ul>
                                        </li>
                                    }
                                </ul>
